 ...
 */
import { IdeContextNotificationSchema } from '@ouroboros/code-cli-core';
...
export class IDEServer {
    ...
    constructor(log, diffManager) {
        ...
        this.portFile = path.join(os.tmpdir(), `gemini-ide-server-${process.ppid}.json`);
    }
    async start(context) {
        ...
        const onDidChangeSubscription = openFilesManager.onDidChange(() => {
            for (const transport of Object.values(transports)) {
                sendIdeContextUpdateNotification(transport, this.log.bind(this), openFilesManager);
            }
        });
