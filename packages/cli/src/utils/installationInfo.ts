...
export function getInstallationInfo(
  ...
  try {
    ...
    if (realPath.includes('/.pnpm/global')) {
      const updateCommand = 'pnpm add -g @ouroboros/multi-agent-cli@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @ouroboros/multi-agent-cli@latest';
      return {
    ...
    if (realPath.includes('/.bun/bin')) {
      const updateCommand = 'bun add -g @ouroboros/multi-agent-cli@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @ouroboros/multi-agent-cli@latest';
    return {
