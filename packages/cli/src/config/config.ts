    ...
    .command('$0', 'Launch Gemini CLI', (yargsInstance) =>
      yargsInstance
        ...
        .option('anthropic-api-key', {
          type: 'string',
          description:
            'Anthropic API key (overrides ANTHROPIC_API_KEY environment variable)',
        })
        .option('prompt', {
          alias: 'p',
          type: 'string',
...
export async function loadCliConfig(
  ...
  if (argv.toolTimeout !== undefined || argv.maxConcurrentTools !== undefined || argv.confirmationMode !== undefined) {
    ...
    const toolExecutionOverrides: Partial<any> = {};
    ...
    if (argv.confirmationMode !== undefined) {
      toolExecutionOverrides['confirmationMode'] = argv.confirmationMode as 'always' | 'never' | 'smart';
    }
    if (Object.keys(toolExecutionOverrides).length > 0) {
      multiProviderMCPConfig.toolExecution = toolExecutionOverrides as any;
    }
  }
