...
getSystemSettingsPath, SETTINGS_DIRECTORY_NAME, // This is from the original module, but used by the mock.
...
describe('Settings Loading and Merging', () => {
    ...
    describe('loadSettings', () => {
        ...
        it('should ignore chatCompression if contextPercentageThreshold is invalid', () => {
            ...
            expect(warnSpy).toHaveBeenCalledWith('Invalid value for chatCompression.contextPercentageThreshold: "1.5". Please use a value between 0 and 1. Using default compression settings.');
            warnSpy.mockRestore();
        });
