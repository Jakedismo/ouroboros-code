...
import { EXTENSIONS_CONFIG_FILENAME, annotateActiveExtensions, loadExtensions, } from './extension.js';
...
describe('loadExtensions', () => {
    ...
    it('should include extension path in loaded extension', () => {
        ...
        fs.writeFileSync(path.join(extensionDir, EXTENSIONS_CONFIG_FILENAME), JSON.stringify(config));
