...
import { GEMINI_CONFIG_DIR as GEMINI_DIR, getErrorMessage, Storage, } from '@ouroboros/code-cli-core';
import stripJsonComments from 'strip-json-comments';
import { DefaultLight } from '../ui/themes/default-light.js';
import { DefaultDark } from '../ui/themes/default.js';
import { isWorkspaceTrusted } from './trustedFolders.js';
export const SETTINGS_DIRECTORY_NAME = '.ouroboros-code';
...
function mergeSettings(system, user, workspace, isTrusted) {
    if (!isTrusted) {
        return {
            ...user,
            ...system,
...
export class LoadedSettings {
    ...
    recomputeMergedSettings(isTrusted) {
        this.isTrusted = isTrusted;
        this._merged = this.computeMergedSettings();
    }
