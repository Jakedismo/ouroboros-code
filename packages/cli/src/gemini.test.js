...
import { main, setupUnhandledRejectionHandler, validateDnsResolutionOrder, } from './gemini.js';
...
describe('gemini.tsx main function', () => {
    ...
    it('should call process.exit(1) if settings have errors', async () => {
        ...
        const mockLoadedSettings = new LoadedSettings(systemSettingsFile, userSettingsFile, workspaceSettingsFile, [settingsError], true);
