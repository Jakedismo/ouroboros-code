...
import { AuthType, GeminiEventType as ServerGeminiEventType, } from '@ouroboros/code-cli-core';
...
describe('useGeminiStream', () => {
    ...
    const renderTestHook = (initialToolCalls = [], geminiClient) => {
        ...
        const { result, rerender } = renderHook((props) => {
            ...
            return useGeminiStream(props.client, props.history, props.addItem, props.config, props.onDebugMessage, props.handleSlashCommand, props.shellModeActive, () => 'vscode', () => { }, () => Promise.resolve(), false, () => { }, () => { }, () => { });
        }, {
            initialProps: {
                client,
                history: [],
    ...
    it('should submit tool responses when all tool calls are completed and ready', async () => {
        ...
        renderHook(() => useGeminiStream(new MockedGeminiClientClass(mockConfig), [], mockAddItem, mockConfig, mockOnDebugMessage, mockHandleSlashCommand, false, () => 'vscode', () => { }, () => Promise.resolve(), false, () => { }, () => { }, () => { }));
    ...
    it('should handle all tool calls being cancelled', async () => {
        ...
        renderHook(() => useGeminiStream(client, [], mockAddItem, mockConfig, mockOnDebugMessage, mockHandleSlashCommand, false, () => 'vscode', () => { }, () => Promise.resolve(), false, () => { }, () => { }, () => { }));
    ...
    it('should not flicker streaming state to Idle between tool completion and submission', async () => {
        ...
        const { result, rerender } = renderHook(() => useGeminiStream(new MockedGeminiClientClass(mockConfig), [], mockAddItem, mockConfig, mockOnDebugMessage, mockHandleSlashCommand, false, () => 'vscode', () => { }, () => Promise.resolve(), false, () => { }, () => { }, () => { }));
    ...
    describe('User Cancellation', () => {
        ...
        it('should call onCancelSubmit handler when escape is pressed', async () => {
            ...
            mockSendMessageStream.mockReturnValue(mockStream);
            const { result } = renderHook(() => useGeminiStream(mockConfig.getGeminiClient(), [], mockAddItem, mockConfig, mockOnDebugMessage, mockHandleSlashCommand, false, () => 'vscode', () => { }, () => Promise.resolve(), false, () => { }, () => { }, cancelSubmitSpy));
            // Start a query
            await act(async () => {
                result.current.submitQuery('test query');
            });
    ...
    describe('Memory Refresh on save_memory', () => {
        it('should call performMemoryRefresh when a save_memory tool call completes successfully', async () => {
            ...
            renderHook(() => useGeminiStream(new MockedGeminiClientClass(mockConfig), [], mockAddItem, mockConfig, mockOnDebugMessage, mockHandleSlashCommand, false, () => 'vscode', () => { }, mockPerformMemoryRefresh, false, () => { }, () => { }, () => { }));
    ...
    describe('Error Handling', () => {
        it('should call parseAndFormatApiError with the correct authType on stream initialization failure', async () => {
            ...
            const { result } = renderHook(() => useGeminiStream(new MockedGeminiClientClass(testConfig), [], mockAddItem, testConfig, mockOnDebugMessage, mockHandleSlashCommand, false, () => 'vscode', () => { }, () => Promise.resolve(), false, () => { }, () => { }, () => { }));
            // 2. Action
            await act(async () => {
    ...
    describe('handleFinishedEvent', () => {
        it('should add info message for MAX_TOKENS finish reason', async () => {
            ...
            const { result } = renderHook(() => useGeminiStream(new MockedGeminiClientClass(mockConfig), [], mockAddItem, mockConfig, mockOnDebugMessage, mockHandleSlashCommand, false, () => 'vscode', () => { }, () => Promise.resolve(), false, () => { }, () => { }, () => { }));
            // Submit a query
            await act(async () => {
