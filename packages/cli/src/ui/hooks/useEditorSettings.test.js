...
import { checkHasEditorType, allowEditorTypeInSandbox, } from '@ouroboros/code-cli-core';
import { SettingsContext } from '../contexts/SettingsContext.js';
vi.mock('@ouroboros/code-cli-core', async () => {
    const actual = await vi.importActual('@ouroboros/code-cli-core');
    return {
        ...actual,
...
describe('useEditorSettings', () => {
    ...
    let mockAddItem;
    const wrapper = ({ children }) => (_jsx(SettingsContext.Provider, { value: { settings: mockLoadedSettings, recomputeSettings: () => { } }, children: children }));
    beforeEach(() => {
        vi.resetAllMocks();
        mockLoadedSettings = new LoadedSettings({ path: '', settings: {} }, { path: '', settings: {} }, { path: '', settings: {} }, []);
    ...
    it('should initialize with dialog closed', () => {
        const { result } = renderHook(() => useEditorSettings(mockSetEditorError, mockAddItem), { wrapper });
