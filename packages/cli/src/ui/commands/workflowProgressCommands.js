 ...
 */
export function processWorkflowProgressCommand(command, args) {
    switch (command) {
        case 'workflow':
        case 'wf': {
 ...
 */
function processProgressCommand(args) {
 ...
 */
function parseProgressFormat(formatStr) {
    if (!formatStr)
        return null;
 ...
 */
export function getWorkflowProgressHelp() {
    return `
...
//# sourceMappingURL=workflowProgressCommands.js.map