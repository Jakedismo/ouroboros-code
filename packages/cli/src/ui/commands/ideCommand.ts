...
import type { Config, IdeClient, File } from '@ouroboros/ouroboros-code-core';
import {
  getIdeInstaller,
  IDEConnectionStatus,
  ideContext,
    ...
    return {
      ...
      action: (): SlashCommandActionReturn =>
        ({
          type: 'message',
          messageType: 'error',
          content: `IDE integration is not supported in your current environment. To use this feature, run Ouroboros Code in one of these supported IDEs: VS Code or VS Code forks.`,
        }) as const,
    };
  }
