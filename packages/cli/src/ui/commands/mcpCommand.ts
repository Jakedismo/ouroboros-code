...
import type { DiscoveredMCPPrompt } from '@ouroboros/ouroboros-code-core';
import {
  DiscoveredMCPTool,
...
const authCommand: SlashCommand = {
  ...
  action: async (
    ...
    try {
      ...
      const { MCPOAuthProvider } = await import('@ouroboros/ouroboros-code-core');
      ...
      const geminiClient = config.getConversationClient();
      if (geminiClient) {
