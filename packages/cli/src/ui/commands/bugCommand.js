...
export const bugCommand = {
    ...
    action: async (context, args) => {
        ...
        if (process.env['SANDBOX'] && process.env['SANDBOX'] !== 'sandbox-exec') {
            sandboxEnv = process.env['SANDBOX'].replace(/^ouroboros-(?:code-)?/, '');
        }
...
`;
        ...
        let bugReportUrl = 'https://github.com/ouroboros-ai/multi-agent-cli/issues/new?template=bug_report.yml&title={title}&info={info}';
