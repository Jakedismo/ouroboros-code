...
import { uiTelemetryService } from '@ouroboros/code-cli-core';
describe('clearCommand', () => {
    ...
    it('should set debug message, reset chat, reset telemetry, and clear UI when config is available', async () => {
        ...
        const resetTelemetryOrder = uiTelemetryService.resetLastPromptTokenCount.mock.invocationCallOrder[0];
