...
import { MultiProviderMCPConfigMerger, DEFAULT_MULTI_PROVIDER_MCP_CONFIG, loadConfigFromEnvironment, } from './multi-provider-mcp-config.js';
...
export class Config {
    ...
    constructor(params) {
        ...
        this.multiProviderMCPConfig = loadConfigFromEnvironment(MultiProviderMCPConfigMerger.merge(params.multiProviderMCPConfig || {}, DEFAULT_MULTI_PROVIDER_MCP_CONFIG));
     ...
     */
    updateMultiProviderMCPConfig(updates) {
        this.multiProviderMCPConfig = MultiProviderMCPConfigMerger.merge(updates, this.multiProviderMCPConfig);
    }
    getUserMemory() {
