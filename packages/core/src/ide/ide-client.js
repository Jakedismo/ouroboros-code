...
export class IdeClient {
    ...
    async connect() {
        ...
        const { isValid, error } = IdeClient.validateWorkspacePath(process.env['GEMINI_CLI_IDE_WORKSPACE_PATH'], this.currentIdeDisplayName, process.cwd());
        if (!isValid) {
        ...
        this.setState(IDEConnectionStatus.Disconnected, `Failed to connect to IDE companion extension for ${this.currentIdeDisplayName}. Please ensure the extension is running. To install the extension, run /ide install.`, true);
    }
    /**
