...
export type SecurityViolationType = 'path_traversal' | 'dangerous_characters' | 'absolute_path_restriction' | 'blocked_directory' | 'directory_not_allowed' | 'blocked_file_type' | 'file_type_not_allowed' | 'executable_file_creation' | 'file_size_exceeded' | 'dangerous_command' | 'command_injection' | 'privilege_escalation' | 'network_access_violation' | 'environment_manipulation' | 'system_file_access';
...
export declare enum SecurityCheckCategory {
...
export interface SecurityCondition {
    type: 'tool_name' | 'parameter_pattern' | 'file_path' | 'command_pattern' | 'provider' | 'risk_level';
