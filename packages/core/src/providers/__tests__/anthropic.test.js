    ...
    describe('AnthropicFormatConverter', () => {
        ...
        describe('fromGeminiFormat', () => {
            ...
            it('should convert system instruction', () => {
                ...
                const unifiedRequest = converter.fromGeminiFormat(geminiRequest);
                expect(unifiedRequest.systemInstruction).toBe('You are Claude, an AI assistant.');
            });
            it('should convert tools', () => {
                ...
                expect(unifiedRequest.tools[0].description).toBe('Search the web for information');
                expect(unifiedRequest.tools[0].parameters.properties.query.type).toBe('string');
        ...
        describe('toProviderFormat', () => {
            ...
            it('should add system instruction', () => {
                ...
                const anthropicRequest = converter.toProviderFormat(unifiedRequest);
                expect(anthropicRequest.system).toBe('You are Claude, an AI assistant.');
                expect(anthropicRequest.messages).toHaveLength(1);
                expect(anthropicRequest.messages[0].role).toBe('user');
            });
            it('should convert tools', () => {
                ...
                expect(anthropicRequest.tools[0].input_schema.properties.query.type).toBe('string');
        ...
        describe('fromProviderResponse', () => {
            it('should convert Anthropic response to unified format', () => {
                ...
                const unifiedResponse = converter.fromProviderResponse(anthropicResponse);
                expect(unifiedResponse.content).toBe('Hello! How can I help you today?');
            ...
            it('should convert tool use responses', () => {
                ...
                const unifiedResponse = converter.fromProviderResponse(anthropicResponse);
                expect(unifiedResponse.content).toBe("I'll search for that information.");
                expect(unifiedResponse.functionCalls).toHaveLength(1);
                expect(unifiedResponse.functionCalls[0].name).toBe('web_search');
                expect(unifiedResponse.functionCalls[0].args.query).toBe('Claude AI capabilities');
        ...
        describe('helper methods', () => {
            it('should create tool result content block', () => {
                const result = converter.createToolResult('toolu_123', 'Search completed', false);
            ...
            it('should create error tool result', () => {
                const result = converter.createToolResult('toolu_123', 'Search failed', true);
    ...
    describe('AnthropicToolAdapter', () => {
        ...
        describe('toAnthropicTool', () => {
            it('should convert UnifiedTool to Anthropic format', () => {
                ...
                expect(anthropicTool.description).toBe('Search the web for information');
        ...
        describe('toAnthropicToolResult', () => {
            ...
            it('should handle object content', () => {
                ...
                const anthropicResult = adapter.toAnthropicToolResult(unifiedResult);
                expect(anthropicResult.content).toBe('{"results":["item1","item2"],"total":2}');
            });
        });
        ...
        describe('processStreamingToolUse', () => {
            it('should process streaming tool use events', () => {
                ...
                const completedUses = adapter.processStreamingToolUse(events, accumulatedUses);
        ...
        describe('helper methods', () => {
            ...
            it('should create error result', () => {
                const result = adapter.createErrorResult('toolu_123', 'Failed to execute');
                expect(result.is_error).toBe(true);
        ...
        describe('conversation handling', () => {
            it('should convert tool uses to message format', () => {
                ...
                const message = adapter.toolUseToMessage(toolUses, "I'll search for that.");
            ...
            it('should create tool execution conversation', () => {
                ...
                const conversation = adapter.createToolExecutionConversation(originalMessage, toolUses, toolResults);
        ...
        describe('confirmation handling', () => {
            ...
            it('should identify dangerous tools requiring confirmation', () => {
                ...
                const dangerousDetails = adapter.extractConfirmationDetails(dangerousToolUse);
