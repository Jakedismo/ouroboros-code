...
describe('Core Built-in Tools Verification', () => {
  ...
  describe('Error Handling', () => {
    ...
    it('should handle execution errors gracefully', async () => {
      ...
      const errorToolCall: UnifiedToolCall = {
        id: 'error-execution',
        name: 'read_file',
      ...
      (toolManager as any).builtinTools.set('read_file', mockTool);
  ...
  describe('Performance Features', () => {
    ...
    it('should provide tool statistics', async () => {
      ...
      await toolManager.executeTool(
        { id: 'stats-1', name: 'read_file', parameters: { file_path: 'test.txt' } },
        mockContext
      );
      await toolManager.executeTool(
        { id: 'stats-2', name: 'ls', parameters: { path: '.' } },
        mockContext
      );
  ...
  describe('Cache Management', () => {
    it('should clear performance cache', async () => {
      ...
      await toolManager.executeTool(
        { id: 'cache-1', name: 'read_file', parameters: { file_path: 'test.txt' } },
        mockContext
      );
 ...
 */
function getTestParameters(toolName: string): Record<string, any> {
