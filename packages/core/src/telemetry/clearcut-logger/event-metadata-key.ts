...
export enum EventMetadataKey {
  ...
  OUROBOROS_CLI_USER_PROMPT_LENGTH = 13,
  ...
  OUROBOROS_CLI_API_REQUEST_MODEL = 20,
  ...
  OUROBOROS_CLI_API_RESPONSE_MODEL = 21,

  // Logs the status code of the response.
  OUROBOROS_CLI_API_RESPONSE_STATUS_CODE = 22,

  // Logs the duration of the API call in milliseconds.
  OUROBOROS_CLI_API_RESPONSE_DURATION_MS = 23,

  // Logs the error message of the API call, if any.
  OUROBOROS_CLI_API_ERROR_MESSAGE = 24,

  // Logs the input token count of the API call.
  OUROBOROS_CLI_API_RESPONSE_INPUT_TOKEN_COUNT = 25,

  // Logs the output token count of the API call.
  OUROBOROS_CLI_API_RESPONSE_OUTPUT_TOKEN_COUNT = 26,

  // Logs the cached token count of the API call.
  OUROBOROS_CLI_API_RESPONSE_CACHED_TOKEN_COUNT = 27,

  // Logs the thinking token count of the API call.
  OUROBOROS_CLI_API_RESPONSE_THINKING_TOKEN_COUNT = 28,

  // Logs the tool use token count of the API call.
  OUROBOROS_CLI_API_RESPONSE_TOOL_TOKEN_COUNT = 29,
  ...
  // Logs the model id of the API call.
  OUROBOROS_CLI_API_ERROR_MODEL = 30,

  // Logs the error type.
  OUROBOROS_CLI_API_ERROR_TYPE = 31,

  // Logs the status code of the error response.
  OUROBOROS_CLI_API_ERROR_STATUS_CODE = 32,

  // Logs the duration of the API call in milliseconds.
  OUROBOROS_CLI_API_ERROR_DURATION_MS = 33,
  ...
  OUROBOROS_CLI_END_SESSION_ID = 34,
  ...
  // Logs the Prompt Id
  OUROBOROS_CLI_PROMPT_ID = 35,

  // Logs the Auth type for the prompt, api responses and errors.
  OUROBOROS_CLI_AUTH_TYPE = 36,

  // Logs the total number of Google accounts ever used.
  OUROBOROS_CLI_GOOGLE_ACCOUNTS_COUNT = 37,

  // Logs the Surface from where the Ouroboros Code was invoked, eg: VSCode.
  OUROBOROS_CLI_SURFACE = 39,

  // Logs the session id
  OUROBOROS_CLI_SESSION_ID = 40,

  // Logs the Ouroboros Code version
  OUROBOROS_CLI_VERSION = 54,

  // Logs the Ouroboros Code Git commit hash
  OUROBOROS_CLI_GIT_COMMIT_HASH = 55,

  // Logs the Ouroboros Code OS
  OUROBOROS_CLI_OS = 82,
  ...
  OUROBOROS_CLI_LOOP_DETECTED_TYPE = 38,
  ...
  OUROBOROS_CLI_SLASH_COMMAND_NAME = 41,

  // Logs the subcommand of the slash command.
  OUROBOROS_CLI_SLASH_COMMAND_SUBCOMMAND = 42,

  // Logs the status of the slash command (e.g. 'success', 'error')
  OUROBOROS_CLI_SLASH_COMMAND_STATUS = 51,
  ...
  OUROBOROS_CLI_RESPONSE_FINISH_REASON = 43,

  // Logs the result of the next speaker check
  OUROBOROS_CLI_NEXT_SPEAKER_CHECK_RESULT = 44,
  ...
  OUROBOROS_CLI_MALFORMED_JSON_RESPONSE_MODEL = 45,
  ...
  OUROBOROS_CLI_KITTY_TRUNCATED_SEQUENCE = 52,

  // Logs the length of the kitty sequence that overflowed.
  OUROBOROS_CLI_KITTY_SEQUENCE_LENGTH = 53,
  ...
  OUROBOROS_CLI_RESEARCH_OPT_IN_STATUS = 66,

  // Logs the contact email for research participation
  OUROBOROS_CLI_RESEARCH_CONTACT_EMAIL = 67,

  // Logs the user ID for research events
  OUROBOROS_CLI_RESEARCH_USER_ID = 68,

  // Logs the type of research feedback
  OUROBOROS_CLI_RESEARCH_FEEDBACK_TYPE = 69,

  // Logs the content of research feedback
  OUROBOROS_CLI_RESEARCH_FEEDBACK_CONTENT = 70,

  // Logs survey responses for research feedback (JSON stringified)
  OUROBOROS_CLI_RESEARCH_SURVEY_RESPONSES = 71,
  ...
  OUROBOROS_CLI_INVALID_CHUNK_ERROR_MESSAGE = 75,

  // Logs the attempt number for a content retry.
  OUROBOROS_CLI_CONTENT_RETRY_ATTEMPT_NUMBER = 76,

  // Logs the error type for a content retry.
  OUROBOROS_CLI_CONTENT_RETRY_ERROR_TYPE = 77,

  // Logs the delay in milliseconds for a content retry.
  OUROBOROS_CLI_CONTENT_RETRY_DELAY_MS = 78,

  // Logs the total number of attempts for a content retry failure.
  OUROBOROS_CLI_CONTENT_RETRY_FAILURE_TOTAL_ATTEMPTS = 79,

  // Logs the final error type for a content retry failure.
  OUROBOROS_CLI_CONTENT_RETRY_FAILURE_FINAL_ERROR_TYPE = 80,

  // Logs the total duration in milliseconds for a content retry failure.
  OUROBOROS_CLI_CONTENT_RETRY_FAILURE_TOTAL_DURATION_MS = 81,

  // Logs the current nodejs version
  OUROBOROS_CLI_NODE_VERSION = 83,
}
