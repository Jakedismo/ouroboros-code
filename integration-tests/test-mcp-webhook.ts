...
import { getWebhookServer, WebhookPayload, WebhookServer } from '../packages/core/src/webhooks/webhook-server.js';
...
describe('MCP Webhook Integration', () => {
  ...
  it('should receive webhook for long-running tool', async () => {
    ...
    webhookServer.registerCallback(testToolId, (payload: WebhookPayload) => {
