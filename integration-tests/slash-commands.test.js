...
describe('Slash Commands Integration Tests', () => {
    ...
    describe('/model Command', () => {
        describe('Basic Model Selection', () => {
            ...
            it('should set model with --provider flag', async () => {
                ...
                const result = await rig.run('/model claude-4-1-opus-20250805 --provider anthropic');
        ...
        describe('Global Model Selection', () => {
            ...
            it('should set multiple models at once', async () => {
                ...
                const result = await rig.run('/model gemini:gemini-2.5-pro openai:gpt-5 anthropic:claude-4-sonnet-20250514');
    ...
    describe('/converge Command', () => {
        it('should synthesize responses from all providers', async () => {
            ...
            expect(result.toLowerCase()).toMatch(/gemini.*openai.*anthropic|all providers/);
        });
        it('should support custom synthesis strategy', async () => {
            rig.setup('converge-strategy');
            const result = await rig.run('/converge --strategy voting What is 2 + 2?');
            expect(result).toContain('4');
            expect(result).toMatch(/voting|vote/i);
        });
        it('should work with model overrides', async () => {
            rig.setup('converge-models');
            const result = await rig.run('/converge --models gemini:gemini-2.5-flash,openai:gpt-5-nano Explain recursion briefly');
    ...
    describe('/compare Command', () => {
        ...
        it('should include latency metrics', async () => {
            ...
            const result = await rig.run('/compare --show-metrics Quick response test');
    ...
    describe('/vote Command', () => {
        it('should conduct voting among providers', async () => {
            ...
            const result = await rig.run('/vote Which is better for web development: React or Vue?');
    ...
    describe('/debate Command', () => {
        it('should conduct multi-round debate', async () => {
            ...
            const result = await rig.run('/debate --rounds 2 Is AI consciousness possible?');
        ...
        it('should summarize consensus and disputes', async () => {
            ...
            const result = await rig.run('/debate Will quantum computing replace classical computing?');
    ...
    describe('User Experience', () => {
        ...
        it('should format output nicely', async () => {
            ...
            const hasAlignment = lines.some((line) => line.includes('  ') || line.includes('\t'));
        ...
        it('should provide progress indicators for long operations', async () => {
            ...
            const result = await rig.run('/converge --strategy ai_synthesis Complex analysis task');
