...
The integration tests are designed to validate the end-to-end functionality of Ouroboros Code. They execute the built binary in a controlled environment and verify that it behaves as expected when interacting with the file system.
...
... output from the ouroboros-code command ...
...
The workflow runs the tests in different sandboxing environments to ensure Ouroboros Code is tested across each:
