# Ouroboros Code Architecture Overview
...
2.  **Core package (`packages/core`):**
    - **Purpose:** This acts as the backend for the Ouroboros Code. It receives requests sent from `packages/cli`, orchestrates interactions with the Gemini API, and manages the execution of available tools.
    - **Key functions contained in the package:**
