...
This document describes the `save_memory` tool for the Ouroboros Code.

## Description

Use `save_memory` to save and recall information across your Ouroboros Code sessions. With `save_memory`, you can direct the CLI to remember key details across sessions, providing personalized and directed assistance.
...
## How to use `save_memory` with the Ouroboros Code
