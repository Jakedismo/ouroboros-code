# Ouroboros Code: Quotas and Pricing

Ouroboros Code offers a generous free tier that covers the use cases for many individual developers. For enterprise / professional usage, or if you need higher limits, there are multiple possible avenues depending on what type of account you use to authenticate.
...
This article outlines the specific quotas and pricing applicable to Ouroboros Code when using different authentication methods.
...
- Model requests will be made across the Gemini model family as determined by Ouroboros Code.
...
If you use up your initial number of requests, you can upgrade your plan to continue to benefit from Ouroboros Code by using the [Standard or Enterprise editions of Gemini Code Assist](https://cloud.google.com/products/gemini/pricing) by signing up [here](https://goo.gle/set-up-gemini-code-assist). Quotas and pricing are based on a fixed price subscription with assigned license seats. For predictable costs, you can log in with Google. This includes:
