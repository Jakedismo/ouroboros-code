...
This page contains tutorials for interacting with Ouroboros Code.
...
Ouroboros Code uses this value in the `mcpServers` configuration that you defined in the `settings.json` file.

#### Launch Ouroboros Code and verify the connection

When you launch Ouroboros Code, it automatically reads your configuration and launches the GitHub MCP server in the background. You can then use natural language prompts to ask Ouroboros Code to perform GitHub actions. For example:
